System.register(['angular2/core', 'angular2/router', './associate', './associate-new.component', './associate.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, associate_1, associate_new_component_1, associate_service_1;
        ...
        execute: function() {
            AssociatesComponent = (function () {
                ...
                AssociatesComponent.prototype.getAssociates = function () {
                    var _this = this;
                    this._AssociatesService.getAssociates().toPromise().then(function (associates) { return _this._Associates = associates; }).then(function (tempAssociates) { return _this.tempAssociates = tempAssociates; });
                };
