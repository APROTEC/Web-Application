System.register(['angular2/core', 'angular2/router', 'angular2-cookie/core', '../../../shared/basics/associate/associate', '../../../shared/email/email.component', '../../../services/associates/associate.service', '../../../shared/loading/loading.component', '../../../shared/alerts/alert.compononet'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, core_2, associate_1, email_component_1, associate_service_1, loading_component_1, alert_compononet_1;
    ...
    return {
        ...
        execute: function() {
            AssociateDetailComponent = (function () {
                function AssociateDetailComponent(_routeParams, _router, _AssociatesService, _CookieService) {
                ...
                AssociateDetailComponent = __decorate([
                    core_1.Component({
                        ...
                        templateUrl: 'app/components/associate/associates/associate-detail/associate-detail.html',
                        styleUrls: ['app/components/associate/associates/associate-detail/styles/associate-detail.css'],
                        inputs: ['associate'],
                    ...
                    __metadata('design:paramtypes', [router_1.RouteParams, router_1.Router, associate_service_1.AssociatesService, core_2.CookieService])
