System.register(['angular2/core', 'angular2/router', '../group-new/group-new.component', '../../../services/groups/group.service', '../../../shared/loading/loading.component'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            GroupsComponent = (function () {
                ...
                GroupsComponent = __decorate([
                    core_1.Component({
                        selector: 'groups',
                        templateUrl: 'app/components/admin/groups/group-list/group-list.html',
                        styleUrls: ['app/components/admin/groups/group-list/styles/group-list.css'],
