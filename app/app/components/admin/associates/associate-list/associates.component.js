System.register(['angular2/core', 'angular2/router', '../associate-new/associate-new.component', '../../../services/associates/associate.service', '../../../shared/loading/loading.component'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            AssociatesComponent = (function () {
                ...
                AssociatesComponent.prototype.getAssociates = function () {
                    var _this = this;
                    this._AssociatesService.getAssociates().retry(5).subscribe(function (associates) {
                ...
                AssociatesComponent = __decorate([
                    core_1.Component({
                        selector: 'associates',
                        templateUrl: 'app/components/admin/associates/associate-list/associates.html',
                        styleUrls: ['app/components/admin/associates/associate-list/styles/associate-list.css'],
